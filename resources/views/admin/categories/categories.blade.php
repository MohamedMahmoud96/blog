              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$category->created_at}}</td>
                   <td>
                    <a href="{{route('admin.edit_category', ['id'=> $category->id])}}" class='btn  btn-info'>Edit</a>
                    <a href="{{route('admin.delete_category', ['id'=> $category->id])}}" class='btn  btn-danger'>Delet</a>
                  </td>
                </tr>
                @endforeach
                @endisset
