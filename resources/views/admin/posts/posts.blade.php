        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{route('admin.create_post')}}" class='pull-right btn  btn-primary'>Add Post</a>
            </div>
              ...
              @foreach($posts as $post)
                ...
                <tr>
                  ...
                  <td>{{$post->created_at}}</td>
                   <td>
                    <a href="{{route('admin.edit_post', ['id'=> $post->id])}}" class='btn  btn-info'>Edit</a>
                    <a href="{{route('admin.delete_post', ['id'=> $post->id])}}" class='btn  btn-danger'>Delet</a>
                  </td>
                </tr>
                @endforeach
                @endisset
